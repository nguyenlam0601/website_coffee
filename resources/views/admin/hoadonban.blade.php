<!doctype html>
<html class="no-js" lang="en" ng-app="myapp" ng-controller="billbancontroller">
<head>
    <meta charset="utf-8">
...
<body>
                        ...
                        <div class="table-responsive">
                            <table class="table table-border text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr ng-repeat ="kh in billbans">
                                        <td>@{{$index+serial+1}}</td>
                                        <td>@{{kh.khachhang.customer_name}}</td>
                                        <td>@{{kh.delivery_address}}</td>
                                        <td >@{{kh.date_order}}</td>
                                        <td >@{{kh.khachhang.phone}}</td>
                                        <td >@{{kh.total|number:0}}</td>
                                        <td >@{{kh.payment}}</td>
                                        ...
                                        <td><button class="btn btn-dark" ng-click="InHD(kh.id)" data-toggle="modal" data-target="#exampleModalLong">&nbsp;Chi tiết</button></td>
                                    </tr>                                
                                </tbody>
                            </table>                          
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body form">
                          ...
                          <table class="table table-hover">
                              ...
                              <tbody>
                                  <tr ng-repeat ="kh in billdbs.cthd">
                                    
                                    <td>@{{kh.id_bill}}</td>
                                    <td>@{{kh.sanpham.product_name}}</td>
                                    <td><img src="/uploads/image/products/@{{kh.image}}" style='width:100px' alt=""></td>
                                    <td>@{{kh.price|number:0}}</td>
                                    <td >@{{kh.amount}}</td>
                                  </tr>
                              </tbody>
                          </table>   
    ...
    <script src="/JS/billbancontroller.js"> </script> 
