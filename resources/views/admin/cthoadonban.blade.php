<!doctype html>
<html class="no-js" lang="en" ng-app="myapp" ng-controller="billdbancontroller">
<head>
    <meta charset="utf-8">
...
<body>
        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h2>QUẢN LÝ CHI TIẾT HOÁ ĐƠN BÁN</h2>                  
                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-border text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr dir-paginate="kh in billdbs|filter: timkiem |itemsPerPage:5">
    ...
    <script src="/JS/billdbancontroller.js"> </script> 
