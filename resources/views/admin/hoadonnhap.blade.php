<!doctype html>
<html class="no-js" lang="en" ng-app="myapp" ng-controller="billnhapcontroller">
<head>
    <meta charset="utf-8">
...
<body>
                        ...
                        <div class="table-responsive">
                            <table class="table table-border text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr ng-repeat ="kh in billnhaps">
                                        <td>@{{$index+serial+1}}</td>
                                        <td>@{{kh.nhacungcap.supplier_name}}</td>
                                        <td>@{{kh.nhanvien.staff_name}}</td>
                                        <td >@{{kh.date_order}}</td>
    ...
    <script src="/JS/billnhapcontroller.js"> </script> 
