<!doctype html>
<html class="no-js" lang="en" ng-app="myapp" ng-controller="ncccontroller">
<head>
    <meta charset="utf-8">
...
<body>
                        ...
                        <div class="table-responsive">
                            <table class="table table-border text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr ng-repeat ="ncc in nhacungcaps">
                                        <td>@{{$index+serial+1}}</td>
                                        <td>@{{ncc.supplier_name}}</td>
                                        <td >@{{ncc.address}}</td>
                                        <td>@{{ncc.email}}</td>
                                        <td >@{{ncc.phone}}</td>
    ...
    <script src="/JS/ncccontroller.js"> </script> 
