                        ...
                        <div class="table-responsive">
                            <table class="table table-border text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr dir-paginate="sp in products|filter: timkiem |itemsPerPage:5">
                                        <td>@{{$index+serial}}</td>
                                ...
                                <div class="container-fluid" class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <div ng-model="product"  > 
                                            ...
                                            <select style="width:40%;" ng-model='product.id_category' class="form-control form-control-lg col-lg-8 col-md-6 col-sm-6" >
